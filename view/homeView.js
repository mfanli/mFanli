define(function(require, exports, module) {
	...
	var Class = Tclass.extend({
		initialize: function(option) {
			...
			this.$$("homeView_header_content").append(gTemplate.homeViewNavigation.render(eBase.getMessageById("homeViewNavigation")));
			...
			this.$$("homeView_radom").append(gTemplate.homeViewArticle.render(eBase.getMessageById("homeViewArticleRadom")));
			this.$$("homeView_near").append(gTemplate.homeViewArticle.render(eBase.getMessageById("homeViewArticleNear")));
		...
		setWeather: function() {
			var self = this;
			$.when(eBase.getWeather()).done(function(weather) {
